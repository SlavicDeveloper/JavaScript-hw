...
let prod_el = document.querySelector(".products");
...
function showCategory(category) {
    let elems_of_cat = products[category];
    let mark_up_to_div = "";
    elems_of_cat.forEach(function(elem){
        mark_up_to_div += getProductMarkup(elem);
    });
    prod_el.insertAdjacentHTML("afterbegin", mark_up_to_div);
}
